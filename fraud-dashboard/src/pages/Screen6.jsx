...
function Screen6() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <p className="text-[#93a3b5] mb-7 text-sm max-w-2xl">
        Fine-tuned RoBERTa classifier, evaluated on a held-out test split of {m.test_size.toLocaleString()} labelled reviews.
      </p>
